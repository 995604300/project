...
abstract class OAuth implements AuthContract
{
     ...
     * @var int
     */
    public static $expires = 43200;//12小时
    ...
    final function authenticate(Request $request)
    {
        ...
        try {
            ...
            throw new  UnauthorizedException('Bearer', '无效的身份验证凭据。');
        }
    }
    ...
    {
        //先行验证是否有传参
        $this->client_id = $request->post('username', null);
        $this->secret = md5($request->post('password', null));
